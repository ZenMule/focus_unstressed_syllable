...
kable(gdur_info_place, caption="Table 1.1. Interaction between place of Articulation and information structure in gesture duration")
```
...
kable(mdisp_place_foot, caption = "Table 1.2. Interaction between footedness and place of articulation in displacement")
```
...
kable(t2pvel_place_info, caption="Table 1.3. Interaction between information structure and place of articulation")
```
...
Table 2.1. Across-accentuation by-speaker comparison
-------------------------------------------------------------------------------------------------------
Speaker|C vs 0|      |      |          |B vs 0|      |      |          |N vs 0|      |      |        
-------|------|------|------|----------|------|------|------|----------|------|------|------|----------
-------|Longer|Larger|Faster|Less stiff|Longer|Larger|Faster|Less stiff|Longer|Larger|Faster|Less stiff
F1     |/t/   |/t/   |-     |/t/|      |-     |-     |-     |-         |-     |-     |-     |-         
F2     |-     |/p/   |/p/   |          |-     |/t/   |-     |-         |-     |-     |-     |- 

Table 2.2. Within-accentuation by-speaker comparison
-------------------------------------------------------------------------------------------------------
Speaker|C vs B|      |      |          |C vs N|      |      |          |N vs B|      |      |      
-------|------|------|------|----------|------|------|------|----------|------|------|------|----------
-------|Longer|Larger|Faster|Less stiff|Longer|Larger|Faster|Less stiff|Longer|Larger|Faster|Less stiff
F1     |/t/   |/t/   |-     |/t/       |/t/   |/t/   |-     |/t/       |-     |-     |-     |/t/        
F2     |-     |/t/   |/t/   |-         |-     |-     |-     |-         |-     |-     |-     |-      

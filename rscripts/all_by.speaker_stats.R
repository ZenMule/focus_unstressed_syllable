...
f1_tt_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = f1_tt)) # Info
TukeyHSD(aov(GDUR ~ Info_str * Footedness, data = f1_tt))             # cntr-bck, cntr-brd, cntr-nrw
...
TukeyHSD(aov(GDUR ~ Info_str * Footedness, data = f2_tt))             # ft-unf 19.24
f2_tb_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = f2_tb))

# M1
m1_ll_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = m1_ll))
m1_tt_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = m1_tt))
m1_tb_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = m1_tb)) 

# M2
m2_ll_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = m2_ll))
m2_tt_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = m2_tt)) 
m2_tb_dur <- summary(aov(GDUR ~ Info_str * Footedness, data = m2_tb)) 

## Displacement ####
# F1
f1_ll_disp <- summary(aov(MDISP ~ Info_str * Footedness, data = f1_ll)) # Ft
TukeyHSD(aov(MDISP ~ Info_str * Footedness, data = f1_ll))              # ft-unf 1.90
...
f2_tt_disp <- summary(aov(MDISP ~ Info_str * Footedness, data = f2_tt))
...
## Peak velocity ####
# F1
f1_ll_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = f1_ll))
f1_tt_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = f1_tt))
f1_tb_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = f1_tb))

# F2
f2_ll_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = f2_ll))
f2_tt_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = f2_tt))
f2_tb_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = f2_tb))

# M1 
m1_ll_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = m1_ll))
m1_tt_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = m1_tt))
m1_tb_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = m1_tb)) 

# M2
m2_ll_pv <- summary(aov(PVEL ~ Info_str * Footedness, data = m2_ll))
...
TukeyHSD(aov(T2PVEL ~ Info_str * Footedness, data = f2_tt))             # ft-unf: 20.69ms
...
TukeyHSD(aov(T2PVEL ~ Info_str * Footedness, data = m1_tt))             # ft-unf: -16.30ms
...
TukeyHSD(aov(T2PVEL ~ Info_str * Footedness, data = m2_ll))             # ft-unf: 11.68ms
m2_tt_tpv <- summary(aov(T2PVEL ~ Info_str * Footedness, data = m2_tt)) 
m2_tb_tpv <- summary(aov(T2PVEL ~ Info_str * Footedness, data = m2_tb))
